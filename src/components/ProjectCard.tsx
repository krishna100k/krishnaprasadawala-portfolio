...
const ProjectCard : React.FC = () => {
  return (
    <div className=" w-full md:w-[48%] h-[25rem] bg-[url('/background-2.jpg')] bg-cover border border-gray-800 relative overflow-hidden">
      <div className="w-full h-14 hover:h-full  bg-black/55 backdrop-blur-lg absolute bottom-0 transition-all duration-500 border-t border-gray-800 cursor-pointer">
        <p className="mt-4 ml-5 mr-5 font-bold ">Project Name</p>
